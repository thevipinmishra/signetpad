...
Put `SignatureSvg` inside the responder surface. It ignores touch events so the adapter remains
the only input owner. Add visible controls and an alternate input path in the containing screen.
